...
df <- data.table::fread(here::here("data/ldsc/rg_results_bw_dx_04092025.txt"))  %>%
    dplyr::mutate(p1 = gsub("/ess/p33/cluster/users/saraes/neurodegen/data/sumstats/formatted_dx/", "", p1),
                  p1 = gsub("/ess/p33/cluster/users/saraes/neurodegen/data/sumstats/formatted/", "", p1),
                  p1 = gsub(".LDSR", "", p1),
                  p2 = gsub("/ess/p33/cluster/users/saraes/neurodegen/data/sumstats/formatted/", "", p2),
                  p2 = gsub("/ess/p33/cluster/users/saraes/neurodegen/data/sumstats/formatted_dx/", "", p2),
                  p2 = gsub(".LDSR", "", p2),
                  p1 = gsub("CARDIOGRAM_CAD_2022", "CAD", p1), 
                  p2 = gsub("CARDIOGRAM_CAD_2022", "CAD", p2),
                  p1 = gsub("GIANT_BMI_2015_EUR", "BMI", p1),
                  p2 = gsub("GIANT_BMI_2015_EUR", "BMI", p2),
                  p1 = gsub("MEGASTROKE_STROKE_2022_AS", "Stroke", p1),
                  p2 = gsub("MEGASTROKE_STROKE_2022_AS", "Stroke", p2),
                  p1 = gsub("PGC_AD_2021_noUKB_no23andMe", "AD", p1),
                  p2 = gsub("PGC_AD_2021_noUKB_no23andMe", "AD", p2),
                  p1 = gsub("NORMENT_PD_2023_Braintyphoon", "PD", p1),
                  p2 = gsub("NORMENT_PD_2023_Braintyphoon", "PD", p2),
                  p1 = gsub("IPDGC_PD_2018", "PD_2018", p1),
                  p2 = gsub("IPDGC_PD_2018", "PD_2018", p2),
                  p1 = gsub("IPDGC_PD_2014_lift", "PD_2014", p1), # no UKB overlap
                  p2 = gsub("IPDGC_PD_2014_lift", "PD_2014", p2),
                  p1 = gsub("T2DGGI_T2D_2024_EUR", "T2D", p1),
                  p2 = gsub("T2DGGI_T2D_2024_EUR", "T2D", p2),
                  p1 = gsub("MEGAVCID_VaD_2024", "VaD", p1),
                  p2 = gsub("MEGAVCID_VaD_2024", "VaD", p2),
                  p1 = gsub("EADB_AD_2022_metadata", "EADB_AD_2022", p1),
                  p2 = gsub("EADB_AD_2022_metadata", "EADB_AD_2022", p2),
                  ) %>%
    dplyr::filter(p1 != "PGC_AD_2021_v2", p2 != "PGC_AD_2021_v2",
                  p1 != "EADB_AD_2022", p2 != "EADB_AD_2022",
                  p1 != "PD_2014", p2 != "PD_2014",
                  p1 != "PD_2018", p2 != "PD_2018",
                  p1 != "VaD", p2 != "VaD") %>%
...
ldsc_metabo_dx <- data.table::fread(here::here("data/ldsc/rg_results_metabo_dx_04092025.txt"))  %>%
    dplyr::mutate(p1 = gsub("/ess/p33/cluster/users/saraes/neurodegen/data/sumstats/formatted/", "", p1),
                  p1 = gsub("/ess/p33/cluster/users/saraes/metabo/ldsc/", "", p1),
                  p1 = gsub(".LDSR", "", p1),
                  p1 = gsub(".munge.sumstats", "", p1),
                  p2 = gsub("/ess/p33/cluster/users/saraes/metabo/ldsc/metabolites/", "", p2),
                  p2 = gsub("/ess/p33/cluster/users/saraes/neurodegen/data/sumstats/formatted_metabo/", "", p2),
                  p2 = gsub(".LDSR", "", p2),
                  p2 = gsub(".munge.sumstats", "", p2),
                  p1 = gsub("CARDIOGRAM_CAD_2022", "CAD", p1), 
                  p2 = gsub("CARDIOGRAM_CAD_2022", "CAD", p2),
                  p1 = gsub("GIANT_BMI_2015_EUR", "BMI", p1),
                  p2 = gsub("GIANT_BMI_2015_EUR", "BMI", p2),
    ...
    dplyr::filter(p1 != "EADB_AD_2022", p2 != "EADB_AD_2022",
                  p1 != "PD_2014", p2 != "PD_2014",
                  p1 != "PD_2018", p2 != "PD_2018",
                  p1 != "VaD", p2 != "VaD") %>%
...
dx_gcg <- data.table::fread(here::here("data/ldsc/rg_results_GCG_dx_04092025.txt"))  %>%
    dplyr::mutate(
                  p1 = gsub("/ess/p33/cluster/users/saraes/neurodegen/data/sumstats/formatted_dx/", "", p1),
                  p1 = gsub(".LDSR", "", p1),
                  p2 = gsub("/ess/p33/cluster/users/saraes/neurodegen/data/sumstats/formatted_GCG/", "", p2),
                  p2 = gsub(".LDSR", "", p2),
                  p1 = gsub("CARDIOGRAM_CAD_2022", "CAD", p1), 
                  p2 = gsub("CARDIOGRAM_CAD_2022", "CAD", p2),
                  p1 = gsub("GIANT_BMI_2015_EUR", "BMI", p1),
...
mr_gcg_dx <- data.table::fread(here::here("data/mr/MR__exposure_dx_outcome_GCG.csv")) %>% 
    dplyr::mutate(method = gsub("Inverse variance weighted", "IVW", method),
                  outcome = gsub("T2DGGI_T2D_2024_EUR.STD", "T2D", outcome),
                  outcome = gsub("CARDIOGRAM_CAD_2022.STD", "CAD", outcome),
                  outcome = gsub("MEGASTROKE_STROKE_2022_AS.STD", "Stroke", outcome),
                  outcome = gsub("GIANT_BMI_2015_EUR.STD", "BMI", outcome),
...
mr_dx_gcg <- data.table::fread(here::here("data/mr/MR__exposure_GCG_outcome_dx.csv")) %>% 
    dplyr::mutate(method = gsub("Inverse variance weighted", "IVW", method),
                  exposure = gsub("T2DGGI_T2D_2024_EUR.STD", "T2D", exposure),
                  exposure = gsub("CARDIOGRAM_CAD_2022.STD", "CAD", exposure),
                  exposure = gsub("MEGASTROKE_STROKE_2022_AS.STD", "Stroke", exposure),
                  exposure = gsub("GIANT_BMI_2015_EUR.STD", "BMI", exposure),
                  exposure = gsub("PGC_AD_2021_noUKB_no23andMe.STD", "AD", exposure),
                  exposure = gsub("NORMENT_PD_2023_Braintyphoon.STD", "PD", exposure),
                  fdr = p.adjust(pval, method = "fdr")) %>% 
     dplyr::mutate(CI_lower = (b - 1.96 * se),
                  CI_upper = (b + 1.96 * se)) %>% 
...
st6 <- data.table::fread(here::here("data/ldsc/rg_results_GCG_dx_04092025.txt"))  %>%
    dplyr::mutate(
                  ...
                  p1 = gsub("NORMENT_PD_2023_Braintyphoon", "PD", p1),
                  p2 = gsub("NORMENT_PD_2023_Braintyphoon", "PD", p2),
                  p1 = gsub("IPDGC_PD_2018", "PD_2018", p1), ## change
                  p2 = gsub("IPDGC_PD_2018", "PD_2018", p2),
                  p1 = gsub("IPDGC_PD_2014_lift", "PD_2014", p1),
                  p2 = gsub("IPDGC_PD_2014_lift", "PD_2014", p2),
                  p1 = gsub("T2DGGI_T2D_2024_EUR", "T2D", p1),
                  p2 = gsub("T2DGGI_T2D_2024_EUR", "T2D", p2),
                  p1 = gsub("MEGAVCID_VaD_2024", "VaD", p1),
...
mixer_new2 <- mixer_new %>%
    ...
    dplyr::mutate(sumstatName = gsub(".fit.json", "", fname),
                sumstatName = gsub("/ess/p33/cluster/users/saraes/neurodegen/data/mixer/bi/", "", sumstatName),
...
mixer_gcg2 <- mixer_gcg %>%
  ...
  dplyr::mutate(sumstatName = gsub(".fit.json", "", fname),
                ...
                trait1 = gsub(".STD.noMHC", "", trait1),
                trait1 = gsub("CARDIOGRAM_CAD_2022", "CAD", trait1),
                trait1 = gsub("GIANT_BMI_2015_EUR", "BMI", trait1),
                trait1 = gsub("MEGASTROKE_STROKE_2022_AS", "Stroke", trait1),
                trait1 = gsub("T2DGGI_T2D_2024_EUR.Z", "T2D", trait1),
                trait1 = gsub("PGC_AD_2021_noUKB_no23andMe.nochr19", "AD", trait1),
                trait1 = gsub("IPDGC_PD_2018", "PD_2018", trait1),
                trait1 = gsub("NORMENT_PD_2023_Braintyphoon", "PD", trait1),
                ) %>% 
    dplyr::rename(
        rg_mean = `rg (mean)`,
...
df_pd <- mixer_glutamine %>%
  dplyr::filter(sumstatName == "NORMENT_PD_2023_Braintyphoon_vs_Glutamine")
df_ad <- mixer_new2 %>%
  dplyr::filter(sumstatName == "PGC_AD_2021_noUKB_no23andMe_nochr19_vs_Glutamine")
df_bmi <- mixer_gcg2 %>%
  dplyr::filter(sumstatName == "GIANT_BMI_2015_EUR_vs_Glutamine")
df_t2d <- mixer_gcg2 %>%
  dplyr::filter(sumstatName == "T2DGGI_T2D_2024_EUR_vs_Glutamine")
df_cad <- mixer_gcg2 %>%
  dplyr::filter(sumstatName == "CARDIOGRAM_CAD_2022_vs_Glutamine")
df_stroke <- mixer_gcg2 %>%
  dplyr::filter(sumstatName == "MEGASTROKE_STROKE_2022_AS_vs_Glutamine")
...
df_pd <- mixer_gcg2 %>%
  dplyr::filter(sumstatName == "NORMENT_PD_2023_Braintyphoon_vs_GCG")
df_ad <- mixer_gcg2 %>%
  dplyr::filter(sumstatName == "PGC_AD_2021_noUKB_no23andMe_nochr19_vs_GCG")
df_bmi <- mixer_gcg2 %>%
  dplyr::filter(sumstatName == "GIANT_BMI_2015_EUR_vs_GCG")
df_t2d <- mixer_gcg2 %>%
  dplyr::filter(sumstatName == "T2DGGI_T2D_2024_EUR_vs_GCG")
df_cad <- mixer_gcg2 %>%
  dplyr::filter(sumstatName == "CARDIOGRAM_CAD_2022_vs_GCG")
df_stroke <- mixer_gcg2 %>%
  dplyr::filter(sumstatName == "MEGASTROKE_STROKE_2022_AS_vs_GCG")
...
mr_cmd <- mr_df %>% 
    ...
    dplyr::mutate(outcome = gsub("GIANT_BMI_2015_EUR.STD", "BMI", outcome),
                  outcome = gsub("T2DGGI_T2D_2024_EUR.STD", "T2D", outcome),
                  outcome = gsub("CARDIOGRAM_CAD_2022.STD", "CAD", outcome),
                  outcome = gsub("MEGASTROKE_STROKE_2022_AS.STD", "Stroke", outcome),
                  outcome = gsub("PGC_AD_2021_noUKB_no23andMe.STD", "AD", outcome),
                  outcome = gsub("NORMENT_PD_2023_Braintyphoon.STD", "PD", outcome), ## change
                  outcome = gsub("IPDGC_PD_2018.STD", "PD_2018", outcome), ## change
                  outcome = gsub("IPDGC_PD_2018.STD", "PD_2014", outcome), ## change
                  fdr = p.adjust(pval, method = "fdr")) %>%
    dplyr::left_join(dict) %>% 
    dplyr::rename(metabolite = prettyName,
                  disorder = outcome)
...
mr_metabo_dx <- data.table::fread(here::here("data/mr/MR__exposure_metabolite_outcome_smd.csv")) %>% 
    ...
    dplyr::filter(outcome != "EADB_AD_2022_metadata.STD" & outcome != "MEGAVCID_VaD_2024.STD") %>% 
    dplyr::mutate(outcome = gsub(".STD", "", outcome),
                  outcome = gsub("GIANT_BMI_2015_EUR", "BMI", outcome),
                  outcome = gsub("T2DGGI_T2D_2024_EUR", "T2D", outcome),
                  outcome = gsub("CARDIOGRAM_CAD_2022", "CAD", outcome), 
                  outcome = gsub("MEGASTROKE_STROKE_2022_AS", "Stroke", outcome),
                  outcome = gsub("PGC_AD_2021_noUKB_no23andMe", "AD", outcome),
                  outcome = gsub("IPDGC_PD_2014_lift", "PD_2014", outcome),
                  outcome = gsub("IPDGC_PD_2018", "PD_2018", outcome),
                  outcome = gsub("NORMENT_PD_2023_Braintyphoon", "PD", outcome), 
                  method = gsub("Inverse variance weighted", "IVW", method)
                  ) %>% 
...
mr_dx_metabo <- data.table::fread(here::here("data/mr/MR__exposure_smd_outcome_metabolite.csv")) %>% 
    ...
    dplyr::mutate(exposure = gsub(".STD", "", exposure),
                  exposure = gsub("GIANT_BMI_2015_EUR", "BMI", exposure),
                  exposure = gsub("T2DGGI_T2D_2024_EUR", "T2D", exposure),
                  exposure = gsub("CARDIOGRAM_CAD_2022", "CAD", exposure), 
                  exposure = gsub("MEGASTROKE_STROKE_2022_AS", "Stroke", exposure),
                  exposure = gsub("PGC_AD_2021_noUKB_no23andMe", "AD", exposure),
                  exposure = gsub("IPDGC_PD_2014_lift", "PD_2014", exposure),
                  exposure = gsub("IPDGC_PD_2018", "PD_2018", exposure),
                  exposure = gsub("NORMENT_PD_2023_Braintyphoon", "PD", exposure),
                  method = gsub("Inverse variance weighted", "IVW", method)
                  ) %>% 
...
mr_gcg_dx <- data.table::fread(here::here("data/mr/MR__exposure_dx_outcome_GCG.csv")) %>% 
    dplyr::mutate(method = gsub("Inverse variance weighted", "IVW", method),
                  ...
                  outcome = gsub("GIANT_BMI_2015_EUR.STD", "BMI", outcome),
                  outcome = gsub("PGC_AD_2021_noUKB_no23andMe.STD", "AD", outcome),
                  outcome = gsub("IPDGC_PD_2014_lift.STD", "PD_2014", outcome),
                  outcome = gsub("IPDGC_PD_2018.STD", "PD_2018", outcome), 
                  outcome = gsub("NORMENT_PD_2023_Braintyphoon.STD", "PD", outcome), 
                  fdr = p.adjust(pval, method = "fdr")) %>% 
     dplyr::mutate(CI_lower = (b - 1.96 * se),
                  CI_upper = (b + 1.96 * se)) %>% 
...
mr_dx_gcg <- data.table::fread(here::here("data/mr/MR__exposure_GCG_outcome_dx.csv")) %>%
    dplyr::mutate(method = gsub("Inverse variance weighted", "IVW", method),
                  ...
                  exposure = gsub("GIANT_BMI_2015_EUR.STD", "BMI", exposure),
                  exposure = gsub("PGC_AD_2021_noUKB_no23andMe.STD", "AD", exposure),
                  exposure = gsub("IPDGC_PD_2014_lift.STD", "PD_2014", exposure),
                  exposure = gsub("IPDGC_PD_2018.STD", "PD_2018", exposure), 
                  exposure = gsub("NORMENT_PD_2023_Braintyphoon.STD", "PD", exposure), 
                  fdr = p.adjust(pval, method = "fdr")) %>% 
     dplyr::mutate(CI_lower = (b - 1.96 * se),
                  CI_upper = (b + 1.96 * se)) %>% 
...
st11 <- data.table::fread(here::here("data/mr/MR__exposure_dx_outcome_trait.csv")) %>%
    ...
    dplyr::filter(exposure != "PD_2014" & outcome != "PD_2014",
                  exposure != "PD_2018" & outcome != "PD_2018") %>%
